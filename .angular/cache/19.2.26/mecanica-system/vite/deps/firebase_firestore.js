        ...
        if (!(k2 < 3) && (k2 != 3 || this.g && (this.h.h || this.g.la() || Ib(this.g)))) {
          ...
          if (this.o) {
            ...
            if (this.R) {
              ...
              this.o = this.o && a;
              if (!a) K2(this.i, this.l, c, "[Invalid Chunked Response]"), Q2(this), Mb(this);
...
var __PRIVATE_BundleLoader = class {
  ...
  Xa(e) {
    return __async(this, null, function* () {
      const t = yield __PRIVATE_localStoreApplyBundledDocuments(e, new __PRIVATE_BundleConverterImpl(this.serializer), this.Ja, this.za.id), n = this.Za(this.documents);
      for (const t2 of this.ja) yield __PRIVATE_localStoreSaveNamedQuery(e, t2, n.get(t2.name));
...
function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.Su) {
      ...
      n.Su = true, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
      ...
      })(n), n.Su = false, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
    }
  });
}
  ...
  return __async(this, null, function* () {
    ...
    for (const e2 of t) {
      ...
      if (n2 && 0 !== n2.length) {
        ...
        for (const e3 of n2) {
          const t3 = r.Au.get(e3), n3 = yield __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
  ...
  (function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    return __async(this, null, function* () {
      try {
        ...
        let s = yield t2.Fu();
        for (; s; ) {
          const e3 = yield i.Ha(s);
          e3 && n2._updateProgress(e3), s = yield t2.Fu();
        }
        const o = yield i.Xa(e2.localStore);
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class ___PRIVATE_IndexedDbOfflineComponentProvider extends __PRIVATE_MemoryOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      yield __superGet(___PRIVATE_IndexedDbOfflineComponentProvider.prototype, this, "initialize").call(this, e), yield this.Lu.initialize(this, e), // Enqueue writes from a previous session
      yield __PRIVATE_syncEngineEnsureWriteCallbacks(this.Lu.syncEngine), yield __PRIVATE_fillWritePipeline(this.Lu.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
  ...
  initialize(e) {
    return __async(this, null, function* () {
      ...
      yield this.persistence.zi((e2) => __async(this, null, function* () {
        yield __PRIVATE_syncEngineApplyPrimaryState(this.Lu.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
      }));
    });
  }
  Mu(e) {
...
var __PRIVATE_BundleReaderImpl = class {
  ...
  Fu() {
    return __async(this, null, function* () {
      return yield this.getMetadata(), this.$u();
    });
  }
  /**
  ...
  Gu(e) {
    return __async(this, null, function* () {
      for (; this.buffer.length < e; ) {
        (yield this.ju()) && this.Qu("Reached the end of bundle when more is expected.");
      }
